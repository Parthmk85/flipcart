            ...
            <div className="bg-white flex rounded-sm shadow-md max-w-4xl w-full overflow-hidden h-[550px]">
                ...
                <div className="bg-primary text-white w-2/5 p-10 flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-gray-200 text-lg">Sign up with your mobile number to get started</p>
                    </div>
                    <img
                ...
                <div className="w-3/5 p-10 flex flex-col justify-between">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <Link href="/login" className="bg-white text-primary font-semibold py-3 rounded-sm shadow-md mt-4 text-center hover:shadow-lg transition-shadow border border-gray-200">
